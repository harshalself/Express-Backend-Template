  ...
  textSources: [
    {
      source_id: 2,
      content:
        "This is an example of a text source that can be used for training or reference.",
    },
    {
      source_id: 2,
      content:
        "Another example text source with different content for variety in training data.",
    },
  ],
};
